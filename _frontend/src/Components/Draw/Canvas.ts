...
/*************  ✨ Windsurf Command ⭐  *************/
/**
 * Clears the entire canvas by filling it with a transparent colour.
 * This is useful for when you want to start drawing from a blank slate.
 */
/*******  98a86cca-d67e-4459-bdf0-0eea1305e596  *******/      type: String,
	...
	methods: {
		...
		zoomAt(x: number, y: number, direction: 'in' | 'out') {
			...
			// ✅ CORRECT offset math (logical space)
			this.offsetX += x * (oldScale - newScale);
			this.offsetY += y * (oldScale - newScale);
